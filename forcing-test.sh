...
readonly CASE_NAME="bb-forcing-test"
...
readonly CASE_ROOT="/pscratch/sd/l/${USER}/forcing-test/bb/${CASE_NAME}"
...
readonly run='custom-21_1x1_ndays'
#readonly run='S_2x5_ndays'
