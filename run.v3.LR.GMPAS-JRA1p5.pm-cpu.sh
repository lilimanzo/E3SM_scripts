...
readonly CASE_NAME="v3.LR.GMPAS-JRA1p5.pm-cpu.test140" # modified name .test1

# If this is part of a simulation campaign, ask your group lead about using a case_group label
# otherwise, comment out
# readonly CASE_GROUP="Tutorials-2024" # LM commented out

# Code and compilation
readonly CHECKOUT="20240504"
readonly BRANCH="master"  # 2f10b6c2f4b092da4c8dfcf88aba1bc31164b9e1
readonly CHERRY=( )
readonly DEBUG_COMPILE=false # LM changed from false to true

# Run options
readonly MODEL_START_TYPE="initial"  # 'initial', 'continue', 'branch', 'hybrid' LM changed from initial to hybrid
...
# Set paths
#readonly CODE_ROOT="/global/cfs/cdirs/e3sm/Tutorials/2024/codes/${CHECKOUT}" ! LM changed code root
readonly CODE_ROOT="/global/homes/l/lili/E3SM.LM"
readonly CASE_ROOT="$PSCRATCH/E3SM.LM/${CASE_NAME}"
...
#readonly run='custom-2_1x10_ndays' # LM orig
#readonly run='custom-4_1x1_nmonths'
#readonly run='custom-4_1x1_nyears'
#readonly run='S_1x10_ndays'
readonly run='S_2x5_ndays' # LM uncommented; test88 change to 1x5
...
if [[ "${run}" != "production" ]]; then
  ...
  readonly WALLTIME="0:30:00" # LM changed from 2:00:00
...
# Coupler history 
readonly HIST_OPTION="ndays" # LM- changed from nyears to ndays
readonly HIST_N="1"
...
do_case_setup=true
do_case_build=true
do_case_submit=false # LM change to false if i want to modify case_scripts files or just see if it builds
...
case_submit() {
    ...
    ./case.submit # -a="--reservation=e3sm_day2" # LM commented out -a=...
