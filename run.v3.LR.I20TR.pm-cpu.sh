...
# Simulation
# <alias>I20TRGSWCNPRDCTCBCTOP</alias>   # the alias to be ready via PR #6362, using long name always ok
readonly COMPSET="20TR_DATM%GSWP3v1_ELM%CNPRDCTCBCTOP_SICE_SOCN_MOSART_SGLC_SWAV"
readonly RESOLUTION="ne30pg2_r05_IcoswISC30E3r5"
readonly CASE_NAME="v3.LR.I20TR.pm-cpu"
...
readonly RUN_REFDIR="/global/cfs/cdirs/e3sm/Tutorials/2024/simulations/init/v3.LR.historical_0101/1970-01-01-00000"
readonly RUN_REFCASE="v3.LR.historical_0101"
readonly RUN_REFDATE="1970-01-01"
...
#readonly run='custom-1_1x10_nsteps'
#readonly run='custom-1_1x10_nhours'
#readonly run='custom-1_1x10_ndays'
readonly run='custom-2_1x1_nmonths'
...
cat << EOF >> user_nl_elm
 ...
 ! Comment this out for a test of nml change (it would fail for current configuration by this script)
 ! still needed even if start off a historical restart point of the same year
 ! The inconsistency is between finidat (as specified) and fsurdat (1850) used in PCT_NAT_PATCH
