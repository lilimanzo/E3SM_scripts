...
readonly CASE_NAME="v3.LR.amip_0101_b2000.pm-cpu"
...
readonly RUN_REFDIR="/global/cfs/cdirs/e3sm/Tutorials/2024/simulations/init/v3.LR.amip_0101/2000-01-01-00000"
...
#readonly run='custom-2_1x6_nhours'    # uncomment this line for the 2nd eam namelist experiment
readonly run='custom-2_1x1_ndays'      # comment out this line for the 2nd eam namelist experiment
#readonly run='custom-2_1x5_ndays'
#readonly run='custom-2_1x10_ndays'
#readonly run='custom-4_1x10_ndays'
#readonly run='custom-2_1x10_nmonths'
#readonly run='custom-8_1x1_nyears'
...
do_case_setup=true
do_case_build=true                  # change to false for the 2nd eam namelist experiment
do_case_submit=true
...
cat << EOF >> user_nl_eam
 ...
 empty_htapes = .true.                           ! With this and fincl1 below, eam.h0 is 230 MB vs 2.2 GB otherwise.

 avgflag_pertape = 'A','A','A','A','I','I','I'   ! A:average, I:instantaneopus, M:min, X:max
 nhtfrq = 0,-24,-6,-3,-1,0,-1                    ! 0 for monthly negative integer for nhours,positive for nsteps
 mfilt  = 1,30,120,240,720,1,240                 ! number of time slices per history file
 ...
 fincl2 = 'PS', 'FLUT','PRECT','U200','V200','U850','V850','CLDHGH','CLDHGH_CAL','CLDTOT','TGCLDLWP','TMQ','LWCF','U10','AODVIS','AODDUST',
 ...
 ! WEST group uncomment the line below  (remove ! before zmconv_dmpdz, reduce fractional mass entrainment rate 
 ! for deep convection scheme, high clouds and LWCF will increase

 ! zmconv_dmpdz = -0.5e-3

 ! EAST group uncomment ( remove ! before do_tms to turn on turbulence mountain stresss, 
 ! which reduces surface wind speed and dust emission over land
