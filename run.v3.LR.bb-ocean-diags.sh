...
readonly CASE_NAME="v3.LR.bb-ocean-diag.test6"
...
readonly RUN_REFDIR="/pscratch/sd/l/lili/bb/ocean/v3.LR.bb-ocean.test1/tests/custom-21_11x48_nmonths/run/restarts/"
readonly RUN_REFCASE="v3.LR.bb-ocean.test1"
readonly RUN_REFDATE="0029-01-01"
...
# Set paths
readonly CODE_ROOT="/${HOME}/E3SM.oceanonly"
...
cat << EOF >> user_nl_eam
 ...
 fincl1 = 'CLDLOW','CLDMED','CLDHGH','CLDTOT',
	  ...
	  'FLUS_SB','LWUP','FLUS', 'LWUP_GB', 'FLUS_EG', 'FLUS_FG', 'TRAD_EG', 'TRAD_FG'
 fincl2 = 'FLUS', 'TRAD', 'LWUP', 'LWUP_GB', 'FLUS_EG', 'FLUS_FG', 'TRAD_EG', 'TRAD_FG', 'FLUS_SB'
 fincl3 = 'FLUS', 'TRAD', 'LWUP', 'LWUP_GB', 'FLUS_EG', 'FLUS_FG', 'TRAD_EG', 'TRAD_FG', 'FLUS_SB'
