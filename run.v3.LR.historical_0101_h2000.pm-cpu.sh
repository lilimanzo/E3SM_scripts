...
readonly CASE_NAME="v3.LR.historical_0101_h2000.pm-cpu"
...
# Set paths
# change CODE_ROOT to the clone repository cloned on day 1
readonly CODE_ROOT=
...
cat << EOF >> user_nl_eam
 ...
 avgflag_pertape = 'A','A','A','A','I','I','I'
 nhtfrq = 0,-24,-6,-3,-1,0,-1
 mfilt  = 1,30,120,240,720,1,240
...
case_submit() {
    ...
    ./case.submit -a="--reservation=e3sm_day3"
